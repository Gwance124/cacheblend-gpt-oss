...
export CACHEBLEND_DECODE_DIAG=1
export CACHEBLEND_TRANSFER_DIAG=1
...
export CACHEBLEND_RUN_BASE_DIR=/mnt/nvme3n1/mlee/cacheblend-gpt-oss/artifacts/solab-g3-m8.5-browsecomp-append-only-prefix-cacheblend-unified-20260818
export CACHEBLEND_RUN_POINTER=/mnt/nvme3n1/mlee/cacheblend-gpt-oss/artifacts/solab-g3-m8.5-browsecomp-append-only-prefix-cacheblend-unified-20260818.current
