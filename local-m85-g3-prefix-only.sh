#!/usr/bin/env bash
# Arm 2 baseline: prefix cache only, NO CacheBlend connector, same GPU.
# Run on g3 to get an apples-to-apples comparison with arm 4.
...
export CACHEBLEND_RUN_BASE_DIR=/mnt/nvme3n1/mlee/cacheblend-gpt-oss/artifacts/solab-g3-m8.5-browsecomp-append-only-prefix-only-20260817
export CACHEBLEND_RUN_POINTER=/mnt/nvme3n1/mlee/cacheblend-gpt-oss/artifacts/solab-g3-m8.5-browsecomp-append-only-prefix-only-20260817.current
...
# No LMCache server needed — prefix cache only.
