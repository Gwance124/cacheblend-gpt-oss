...
4. [selective backend contract](docs/runbooks/solab-g3-selective-contract.md), only after the earlier numerical gates
5. [controlled benchmark](docs/runbooks/solab-g3-benchmark.md), only after correctness artifacts exist
